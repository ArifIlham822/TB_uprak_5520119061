...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">{{ __('Pengelolaan Categories') }}</div>
                <div class="card-body">
                                    ...
                                    <td>{{ $categorie->description }}</td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" id="btn-edit-categories" class="btn btn-success" data-toggle="modal" data-target="#editcategorie" data-id="{{ $categorie->id }}">Ubah</button>
                                                <button type="button" id="btn-delete-buku" class="btn btn-danger" data-toggle="modal" data-target="#deleteBukuModal" data-id="{{ $categorie->id }}" data-cover="{{ $categorie->cover }}">Hapus</button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
